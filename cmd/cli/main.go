...
--interval 		Set the interval of your task [--interval 360] (seconds)

Commands:
endpoint		Create a new endpoint [options... endpoint "myendpoint"]
process 		Create a new process [options... process "myprocess"]
task 			Create a new task [options... task "mytask"]
